...
/**
 * 一个PropertyEntry表示一个相关属性条目的组。
 * 在组前面的说明表示名称。
 * 该类别可以从一个读者对象（reader object）获取它的名称和条目。
 * @author Dell
 *
 */
public class PropertyCategory extends PropertyElement{
	...
	public PropertyCategory(PropertyElement parent, LineNumberReader reader) throws IOException {
		super(parent);
