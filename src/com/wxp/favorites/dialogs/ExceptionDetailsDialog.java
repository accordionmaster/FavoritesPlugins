...
public class ExceptionDetailsDialog extends AbstractDetailsDialog{
	...
	public ExceptionDetailsDialog(IShellProvider parentShell, String title, Image image, String message,
			Object details, Bundle bundle) {
	...
	// getMessage方法和帮助方法创建基于提供的消息和细节对象的消息。
	...
	// 当点击Details按钮时，超类决定细节区域是否要显示或隐藏，以及在需要时，调用
	// createDetailsArea()方法为细节区域创建内容。
	...
	private Control createDetailsViewer(Composite parent) {
		if (details == null) {
			return null;
		}
